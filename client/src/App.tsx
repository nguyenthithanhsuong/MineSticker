        ...
        <div style={{
          ...
          {gameStarted && (
            <div
              style={{
                position: "absolute",
                top: charPos.row * GRID_SIZE - (48 - 16),
                left: charPos.col * GRID_SIZE - (48 - 16) / 2,
                width: 48,
                height: 48,
                backgroundImage: `url(${CHAR_SPRITE_SHEET})`,
                backgroundPosition: `-${CHAR_FULL_COORDS.x1}px -${CHAR_FULL_COORDS.y1}px`,
                backgroundSize: "auto",
                pointerEvents: "none",
                zIndex: 10
              }}
